...
class NeuralNetwork:
	...
	def deep_nn(self, x):
		...
		h_pool2 = self.max_pool_2x2(h_conv2)  # Reduces image to 7x7 pixels
	...
	def train(self, data, model_path, test_only=False, steps=1000, batch_size=50, show_test=True):
	...
	def predict_digit(self, test_images, model_path, flatten=True, normalise=True, probabilities=False):
		"""Prediction function
