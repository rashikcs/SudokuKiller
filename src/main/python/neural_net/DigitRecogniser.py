...
from neural_net.NeuralNetwork import NeuralNetwork
...
class DigitRecogniser:
	...
	def prepare_images(self, test_images, normalise=True, flatten=True):
		if normalise:
	...
	def predict_digit(self, test_images, normalise=True, flatten=True, weights=False, threshold=0):
		...
		"""
		test_images = self.prepare_images(test_images, normalise, flatten)
